...
describe('CommentRepositoryPostgres', () => {
  ...
  describe('softDeletComment function', () => {
    it('should throw authorization error when user id not match given comment owner', async () => {
      ...
      // Assert
      await expect(commentRepositoryPostgres.softDeleteComment('thread-1', 'comment-1', 'user-1'))
        .rejects
    ...
    it('should delete comment successfully', async () => {
      ...
      await expect(commentRepositoryPostgres.softDeleteComment('thread-1', 'comment-1', 'user-123'))
        .resolves
        .not
        .toThrow();
